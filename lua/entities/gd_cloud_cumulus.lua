...
ENT.Contact		                     =  "Hmm"
ENT.Category                         =  "Hmm"
ENT.Models                           =  {"models/ramses/models/atmosphere/clouds/cumulus_a.mdl","models/ramses/models/atmosphere/clouds/cumulus_c.mdl"}
...
ENT.LifeMin                          = 10 
ENT.LifeMax                          = 20 
ENT.DefaultColor                     = Color(math.random(0,25),math.random(0,25),math.random(0,25),0)
ENT.AlphaMax                         = 100
