...
function ENT:Initialize()	
	...
	if (SERVER) then
		...
		if (phys:IsValid()) then
			phys:SetMass(math.random(400,500))
		end 		
...
function ENT:Explode()
	...
	pe:SetKeyValue( "Magnitude", 1650 );
	pe:SetKeyValue( "radius", 2400 );
	...
	util.BlastDamage( self, self, self:GetPos()+Vector(0,0,12), 512, math.random( 400, 450 ) )
