...
ENT.Data.Effect                      = {"firenado_hd_main", "mega_firenado"}
ENT.Data.Parent                      = nil
ENT.Data.ShouldFollowPath            = false
ENT.Data.EnhancedFujitaScale         = "EF5"

ENT.Data.MaxFunnel.Height 			 = 7000
ENT.Data.MaxFunnel.Radius 			 = 4000 -- funnel radius at max height
ENT.Data.MinFunnel.Height			 = 0   
ENT.Data.MinFunnel.Radius 			 = 4000    -- funnel radius at min height

ENT.Data.GroundSpeed.Min  			 = 5
ENT.Data.GroundSpeed.Max 			 = 10

ENT.Data.Life.Min                    = 120
ENT.Data.Life.Max                    = 180

ENT.Data.MaxGroundFunnel.Height      = 1000
ENT.Data.MaxGroundFunnel.Radius      = 4000
ENT.Data.MinGroundFunnel.Height      = -100
ENT.Data.MinGroundFunnel.Radius      = 5600
...
function ENT:PostSpawn()
	...
	function self.TornadoENT:DamagingAura()
		...
		if CurTime() >= self.NextFireDamageTime then
			self.NextFireDamageTime = self.NextFireDamageTime + 0.2
			 self:OnDamagingAura()
			---
		else 
