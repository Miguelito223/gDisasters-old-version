...
cloud_intensity_to_weather_ent = {
	...
	["gd_w1_sleet"] = 0.5,
	["gd_w1_heavyfog"] = 0.4, 
	["gd_w1_cldy_cumu"] = 0.25, 
	
	["gd_w2_heavy_snow"] = 0.5, 
	["gd_w2_extremerain"] = 0.8,
	["gd_w2_acidrain"] = 0.5, 
	["gd_w2_mildbreeze"] = 0,
	["gd_w2_heatwave"] = 0.2,
	["gd_w2_blizzard"] = 0.8,
	...
	["gd_w2_coldwave"] = 0.1,
	["gd_w2_hailstorm"] = 0.9,
	["gd_w2_thunderstorm"] = 0, 
	
	["gd_w3_martianduststorm"] = 0.8, 
	["gd_w3_heatburst"] = 1,
	["gd_w3_strongbreeze"] = 0,
	["gd_w3_supercell"] = 1,
	
	["gd_w4_extremebreeze"] = 0,
	
	["gd_w5_downburst"] = 1,
	
	["gd_w7_solarray"] = 0.5, 
	["gd_w7_martiansnow"] = 0.8,  
...
function ENT:Initialize()	
	...
	if (CLIENT) then 
		...
		local t =  ( (1 / (engine.TickInterval())) ) / 66.666 * 0.01	
		
		self.NextDisplayUpdateTime  = (CurTime()	+ t)
		self.NextDisplayRefreshTime = (CurTime() + t)
	
		self.StartTime             = (CurTime() + t)
